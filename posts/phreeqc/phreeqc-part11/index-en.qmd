...
The reaction-path modeling learned here is applied to the Kirishima volcanic springs in [Groundwater Science #15 — Silicate Weathering and Groundwater Residence Time](/posts/groundwater/groundwater-sci15/index-en). There, minerals are dissolved little by little into a dilute recharge water, and the "water-chemistry maturation" in which secondary minerals shift from gibbsite → kaolinite → Ca-smectite is followed — a field application of this method.
:::
