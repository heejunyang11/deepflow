...
nocite: |
  @*
---
::: {.callout-tip title="すでにPHREEQCの準備ができている方へ"}
「インストール方法はすでに知っている」「特定の計算や高度なテーマをすぐに調べたい」という方は、以下の各テーマの解説記事へ直接ジャンプしてください。

- **化学種分化・溶液計算（Speciation）**:
  - [#2 海水組成の計算と化学種分化](/posts/phreeqc/phreeqc-part2/)
  - [#9 イオン強度と活性係数の謎](/posts/phreeqc/phreeqc-part9/)
- **溶液混合と平衡計算（Mixing & Equilibrium）**:
  - [#3 溶液の混合と平衡相](/posts/phreeqc/phreeqc-part3/)
  - [#5 混合腐食と石灰岩溶解ポテンシャル](/posts/phreeqc/phreeqc-part5/)
- **飽和指数（Saturation Index: SI）**:
  - [#10 飽和指数（SI）のマスター：溶解か沈殿か](/posts/phreeqc/phreeqc-part10/)
- **反応速度論・速度モデリング（Kinetics & Rates）**:
  - [#4 反応速度論の基礎とKINETICS設定](/posts/phreeqc/phreeqc-part4/)
  - [#19 比表面積（SSA）設定の罠：単位換算の落とし穴](/posts/phreeqc/phreeqc-part19/)
- **物質移行・移流分散（Transport）**:
  - [#12 1次元移流分散モデルと溶質移行](/posts/phreeqc/phreeqc-part12/)
:::
...
**次のステップ：[#2 Seawaterデータのインプットと化学種分布（Speciation）の計算へ](/posts/phreeqc/phreeqc-part2/)**

::: {.callout-tip}
## 関連シリーズ：地下水科学入門
PHREEQC が「水の**化学**」を扱うのに対し、水そのものの**流れ**（涵養・帯水層・水理勾配）を基礎から学びたい方は、[地下水科学入門シリーズ #1：水循環とは？— 雨はどこへ行くのか](/posts/groundwater/groundwater-sci01/) から始めるのがおすすめである。
:::
