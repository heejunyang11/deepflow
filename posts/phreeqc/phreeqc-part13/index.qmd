...
![地下水における酸化還元反応の熱力学的シークエンス（Appelo & Postma, 2005より改変）](F1.png)
...
1.  **PHREEQC公式ドキュメント** Parkhurst, D.L., and Appelo, C.A.J., 2013. Description of input and examples for PHREEQC version 3—A computer program for speciation, batch-reaction, one-dimensional transport, and inverse geochemical calculations: U.S. Geological Survey Techniques and Methods, book 6, chap. A43, 497 p.
2.  **地球化学モデリングの標準的専門書** Appelo, C., Postma, D., 2005. *Geochemistry, Groundwater and Pollution*, second ed. Balkema, Rotterdam, p. 634.
3.  **本チュートリアルの手法を用いた研究例（著者論文）** Yang H., Mishima T., Katazakai S., Kagabu M., 2023. Analytical approach using a chemical equilibrium formula and geochemical modeling for alkalinity measurements of small natural water samples. *Applied Geochemistry* 148:105535. 👉 著者のその他の研究業績については [Aboutページ](/about.html) をご覧ください。
...
- #14 硝酸塩汚染の地下水診断 — 脱窒はどこで、どれだけ起きているか (Coming Soon)
