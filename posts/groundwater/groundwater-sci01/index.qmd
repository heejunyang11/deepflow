---
title: "地下水科学入門 #1：水循環とは？— 雨はどこへ行くのか"
description: "水循環の基本と水収支を理解し、地下水がなぜ特別な存在なのかをPythonで可視化する"
author: "Heejun Yang"
date: "2026-06-03"
...
地球上の水の約**97.5%は海水（塩水）**であり、淡水はわずか**2.5%**に過ぎない。さらにその淡水の約68.7%は氷河・氷床として固定されており、液体の淡水として存在するのはごくわずかである。
...
**② 降水（Precipitation）**  
大気中の水蒸気が凝結し、雨・雪として地表へ降り注ぐ。日本の年間降水量は約1,700mmで、世界平均（約800mm）の約2倍となっている。
...
日本では降水量の約**8%**が地下水として涵養されると推定される。この数字は地域・地質・土地利用によって大きく変わる——それが後続のテーマへとつながっていく。
