...
The **water cycle** (also called the **hydrologic cycle**) is the continuous movement of water among the ocean, atmosphere, and land — evaporating, forming clouds, falling as precipitation, and returning to the sea through rivers and underground. It has no beginning or end: the same water has circulated for billions of years, only changing form and location.

Crucially for this series, one leg of that loop runs **underground** — water that infiltrates the soil becomes groundwater and can stay there for years to millennia before rejoining the cycle. First, let us see how much water the Earth actually holds, and where.
...
### The 5 Stages of the Water Cycle {#sec-processes}
