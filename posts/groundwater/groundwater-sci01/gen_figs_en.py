...
labels_total = ['Oceans (97.5%)', 'Freshwater (2.5%)']
...
labels_fresh = ['Glaciers & Ice (68.7%)', 'Groundwater (30.1%)', 'Other (0.9%)', 'Surface Water (0.3%)']
...
plt.suptitle("Earth's Water Resources: Groundwater is the Largest Liquid Freshwater Reservoir", 
             fontsize=20, fontweight='heavy', y=1.05, color=TITLE_COLOR)
plt.tight_layout()
plt.savefig('fig-water-distribution-en.png', dpi=150, bbox_inches='tight', facecolor=BG_COLOR)
plt.close()
...
categories = ['Precipitation (P)', 'Evapotranspiration\n(ET)', 'Runoff (Q)', 'Recharge (R)\n(Estimated)']
values = [P, ET, Q, R]
...
ax.set_title('Annual Water Budget of Japan (Approx.)\nP = ET + Q + R', 
...
plt.tight_layout()
plt.savefig('fig-water-budget-en.png', dpi=150, bbox_inches='tight', facecolor=BG_COLOR)
plt.close()
...
# ==========================================
reservoirs = [
    'Atmosphere', 'Soil Moisture', 'Rivers', 'Lakes', 
    'Oceans', 'Glaciers & Ice Caps', 'Shallow Groundwater', 'Deep Groundwater'
]
...
labels_text = ['10 days', '~6 months', '~2 weeks', '~5 years',
               '~3,000 years', '~16,000 years', '~100 years', '~100,000 years']
...
ax.set_title('Average Residence Time of Water Reservoirs', 
             fontsize=18, fontweight='bold', color=TITLE_COLOR, pad=20)
...
plt.tight_layout()
plt.savefig('fig-residence-time-en.png', dpi=150, bbox_inches='tight', facecolor=BG_COLOR)
plt.close()

print("Premium English figures generated successfully.")
