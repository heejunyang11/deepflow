...
format:
  html:
    include-in-header:
      - text: |
          <link rel="alternate" hreflang="ja" href="https://deepflows.net/posts/groundwater/groundwater-sci15/" />
          <link rel="alternate" hreflang="en" href="https://deepflows.net/posts/groundwater/groundwater-sci15/index-en" />
---

## Introduction: water chemistry is a function of age

In [#14](/posts/groundwater/groundwater-sci14/index-en) we saw how to measure the **age (residence time)** of groundwater — isotopes for the recharge source, tritium and ⁸⁵Kr for the age. What we obtained there was a "clock for water." This article reuses that clock as a **time axis for chemical change**. The question is this:
...
The saturation index SI = log(IAP/K) tells whether the water is supersaturated (SI \> 0, can precipitate) or undersaturated (SI \< 0, can dissolve) with respect to a mineral. For the detailed meaning of SI and how to use it in PHREEQC, see the sister series [PHREEQC from Scratch #10: Mastering the Saturation Index (SI)](/posts/phreeqc/phreeqc-part10/index-en).
:::
...
Finally, we plot all 37 springs on an **activity diagram** (@fig-act). With dissolved silica on the horizontal axis and log(aCa²⁺/aH⁺²) on the vertical axis, this classical diagram lets you read at a glance which mineral is stable. Onto it we overlaid the trajectory of the reaction path from the previous section. The drawing of such solubility diagrams itself is covered in [PHREEQC from Scratch #7: Solubility Diagrams (Gibbsite)](/posts/phreeqc/phreeqc-part7/index-en).
...
Therefore, to solve this system truly quantitatively requires a **reactive transport model** that couples chemical reaction with mass transport (advection, dispersion, mixing). PHREEQC itself has functions for advection and dispersion, whose basics were introduced in [PHREEQC from Scratch #12: Advection–Dispersion Modeling](/posts/phreeqc/phreeqc-part12/index-en). This article stopped at equilibrium calculation, but the division of labor — **"equilibrium tells the endpoint; transport tells the road to it"** — is itself the starting point for the next step.

------------------------------------------------------------------------

## Connection to #12 and #13

This "story of time" runs through the entire water-quality sub-series. In [#12](/posts/groundwater/groundwater-sci12/index-en) (fluoride) and [#13](/posts/groundwater/groundwater-sci13/index-en) (arsenic), the high concentrations clustered in the **long-residence stagnant zone**. In the language of this article, that is "the most matured water." Water that has drifted toward Na type by ion exchange (#12), become reduced (#13), and matured in its secondary minerals all the way to smectite — on one and the same time axis stand fluoride, arsenic, and the phase transition of silica and clay.
...
- [#1: Installation and Your First Calculation](/posts/phreeqc/phreeqc-part1/index-en) — the entrance to the series
- [#7: Solubility Diagrams (Gibbsite)](/posts/phreeqc/phreeqc-part7/index-en) — how to draw this article's activity diagram
- [#10: Mastering the Saturation Index (SI)](/posts/phreeqc/phreeqc-part10/index-en) — the basis of Reproduction ①
- [#11: Reaction-Path Modeling](/posts/phreeqc/phreeqc-part11/index-en) — the basis of Reproduction ②
- [#12: Advection–Dispersion Modeling](/posts/phreeqc/phreeqc-part12/index-en) — the road toward the "reactive transport" this article left as homework
- [#16: Introduction to Reaction Kinetics (KINETICS)](/posts/phreeqc/phreeqc-part16/index-en) — the next step, treating the "speed" of maturation
:::
