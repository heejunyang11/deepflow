...
format:
  html:
    include-in-header:
      - text: |
          <link rel="alternate" hreflang="ja" href="https://deepflows.net/posts/groundwater/groundwater-sci17/" />
          <link rel="alternate" hreflang="en" href="https://deepflows.net/posts/groundwater/groundwater-sci17/index-en" />
---
...
In [#6](/posts/groundwater/groundwater-sci06/index-en) we saw the unconfined groundwater level at Beppu respond to **barometric pressure**: when the air presses harder on the aquifer, the level falls. In [#9](/posts/groundwater/groundwater-sci09/index-en) we saw the level on Minami-Daito Island respond to **ocean tides**, and used the phase lag to estimate hydraulic conductivity across the island.
...
This article extends that view to **crustal strain**. The tools are the same as well: the harmonic analysis used in [#9](/posts/groundwater/groundwater-sci09/index-en) to isolate tidal constituents is exactly what calibrates the strain meter here.
...
The well that responded to barometric pressure in [#6](/posts/groundwater/groundwater-sci06/index-en), the well that responded to ocean tides in [#9](/posts/groundwater/groundwater-sci09/index-en), and the well that responded to earthquake strain here are **the same well**. Only the forcing differs; the framework for reading it is one. Barometric response gives loading efficiency, tidal response gives strain sensitivity, coseismic steps give crustal deformation. **The same record returns a different answer each time the question changes** — that is the power of time-series analysis.
...
What happens beneath a volcano? How does the hot fluid separating from magma react with the surrounding rock, and what kind of water emerges at the surface? The geothermometers of [#16](/posts/groundwater/groundwater-sci16/index-en) told us the *temperature* but said nothing about the *source* of that heat. The next article fills that gap, re-reading the magma ascent that moved the water level at Usu from the side of chemistry.
