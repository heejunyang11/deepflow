...
![(Left) The tide-generating force of the Moon and Sun: its basic mechanism (the balance between gravitational and centrifugal forces), why two tides occur each day, and the difference between spring and neap tides. (Top right) Sea-level fluctuations in Florida and their FFT spectrum (Merritt, 2004). (Bottom right) The major harmonic constituents of the tide. Distinct peaks separate at the semidiurnal and diurnal periods.](Tidal_v2_en.png){#fig-tidal-v2}
