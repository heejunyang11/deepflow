...
format:
  html:
    include-in-header:
      - text: |
          <link rel="alternate" hreflang="ja" href="https://deepflows.net/posts/groundwater/groundwater-sci09/" />
          <link rel="alternate" hreflang="en" href="https://deepflows.net/posts/groundwater/groundwater-sci09/index-en" />
---

## Introduction: turning the tide into a tool

In [#7](/posts/groundwater/groundwater-sci07/index-en) we watched the freshwater lens beneath the remote island of Minami-Daito "breathe" quietly in step with the ocean tide. When the sea rises, the water table rises; when it falls, the table falls. We pulled that oscillation out with the FFT.
