...
Up to [#10](/posts/groundwater/groundwater-sci10/index-en.html), the story was about *water level* — a matter of physics. From here we step into the water's **contents**: its chemistry.
...
4.  **Mixing** — fresh water blends with deep thermal water, or with seawater. Ubiquitous in freshwater lenses ([#7](/posts/groundwater/groundwater-sci07/index-en.html)) and in coastal / geothermal areas.
...
The Ca concentration at saturation scales roughly as $p\mathrm{CO_2}^{1/3}$. In settings with high soil CO₂ ($p\mathrm{CO_2}=10^{-1.5}$ to $10^{-1}$ atm), Ca reaches 2–4 mmol/L. [PHREEQC from scratch #5](/posts/phreeqc/phreeqc-part5/index-en.html) defines a carbonate groundwater with "Ca ≈ 3–4 mmol/kg, calcite SI ≈ 0" under higher CO₂ — continuous with the calculation here. The full PHREEQC workflow is taught from the ground up in the [PHREEQC series](/blog-en.html).
:::
...
> Not just *reading* the major ions but *classifying* them with multivariate statistics — treating water-quality data with the same mindset as the time-series methods from [#8](/posts/groundwater/groundwater-sci08/index-en.html) onward.
