...
image: "images/phreeqc-08-thumbnail.png"
---
...
Quarto ブログに `![](gibbsite_solubility.svg)` で挿入すると、 どの解像度のディスプレイでも鮮明に表示される。 PDF 出力にも対応できるのでベクター形式を推奨する。
:::
...
```{=html}
<!-- 優勢化学種マップ（SVG代替・HTML版） -->
<div style="background:#FDFDFD; border:1px solid #E5E7EB; border-radius:10px; padding:1.5em; margin:1.5em 0;">
<p style="font-weight:700; color:#374151; margin:0 0 0.8em 0; font-size:0.95em;">Al 優勢化学種マップ（Gibbsite 平衡, 25°C）</p>
<div style="display:flex; gap:4px; align-items:center; flex-wrap:nowrap; overflow-x:auto;">
  <div style="flex:1; min-width:52px; background:#DC2626; border-radius:6px; padding:10px 4px; text-align:center; color:white; font-size:0.75em; font-weight:700; white-space:nowrap;">Al³⁺<br><span style="opacity:0.8; font-weight:400;">pH 3–4</span></div>
  <div style="flex:0.5; min-width:40px; background:#EA580C; border-radius:6px; padding:10px 4px; text-align:center; color:white; font-size:0.75em; font-weight:700; white-space:nowrap;">AlOH²⁺<br><span style="opacity:0.8; font-weight:400;">pH 5</span></div>
  <div style="flex:0.5; min-width:40px; background:#CA8A04; border-radius:6px; padding:10px 4px; text-align:center; color:white; font-size:0.75em; font-weight:700; white-space:nowrap;">Al(OH)₂⁺<br><span style="opacity:0.8; font-weight:400;">pH 6</span></div>
  <div style="flex:1.2; min-width:60px; background:#16A34A; border-radius:6px; padding:10px 4px; text-align:center; color:white; font-size:0.75em; font-weight:700; white-space:nowrap;">Al(OH)₃(aq)<br><span style="opacity:0.8; font-weight:400;">pH 7–8</span></div>
  <div style="flex:2.5; min-width:80px; background:#2563EB; border-radius:6px; padding:10px 4px; text-align:center; color:white; font-size:0.75em; font-weight:700; white-space:nowrap;">Al(OH)₄⁻<br><span style="opacity:0.8; font-weight:400;">pH 9–14</span></div>
</div>
<p style="font-size:0.78em; color:#9CA3AF; margin:0.6em 0 0 0; text-align:center;">各ブロックの幅は優勢 pH 域の広さに対応</p>
</div>
```

::: {#layout-map}
\![正確な計算結果に基づくAl優勢化学種マップ\](Figure_1.png){width="80%" fig-align="center"}

正確なシミュレーション結果により、pH 6付近での \$Al(OH)\_2\^+\$ の出現や、広範なアルカリ域での \$Al(OH)\_4\^-\$ の優勢状況が確認できます。
:::
...
上記 Step 1〜5 をひとつのスクリプトにまとめた完全版だ。
